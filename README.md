...
The separation is meant to separate issues with the Messenger Server and Messenger Client. Please open any issues with the Messenger Client here.
...
./messenger-client-cpp example.com <encryption_key>
...
./messenger-client-cpp ws+http+https://example.com:8080 <encryption_key>

# Connect the Messenger Client to example.com on port 443 using HTTPS only
./messenger-client-cpp https://example.com <encryption_key>

# With remote port forwards
./messenger-client-cpp example.com <encryption_key> localhost:8080:remotehost:8080
```
